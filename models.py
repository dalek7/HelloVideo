...
class ModelLoader():
    ...
    def __init__(self, n_labels, seq_length, model_name,
                 saved_weights=None, optimizer=None, image_size=(224, 224)):
    ...
    def cnn_lstm(self):
        ...
        # Conv Block 1
        model.add(TimeDistributed(Conv2D(64, kernel_size, strides=strides, activation='relu',
                         padding='same', input_shape=self.input_shape)))
        model.add(TimeDistributed(MaxPooling3D(pool_size=(1, 2, 2), strides=(2, 2))))
